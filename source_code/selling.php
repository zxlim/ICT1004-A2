							...
							<form id="form_selling" name="form_selling" action="selling.php" method="post">
								<div class="s_product_text">
									...
									<div class="form-group">
										<h4>Listing Name</h4>
										<input type="text" id="product_name" name="product_name" class="form-control" placeholder="E.g. iPhone">
									...
									<div class="form-group">
										...
										<input type="text" id="listing_expiry" name="listing_expiry" class="form-control" placeholder="yyyy/mm/dd">
										<span class="text-danger"><?php safe_echo($error_date); ?></span>
									</div>

									<div class="form-group">
										<h4>Tags</h4>
										<input type="text" class="form-control" id="tags" name="tags" placeholder="Search tags, separate with comma">
									...
									<div class="row">
										<div class="col-lg-3 form-group">
											<h4>Condition</h4>
											<input type="number" id="condition" name="condition" class="form-control" min="1" max="10" placeholder="1 to 10">
										</div>

										<div class="col-lg-4 form-group">
											<h4>Age</h4>
											<input type="number" id="age" name="age" class="form-control" min="0" placeholder="Age in months">
										</div>
