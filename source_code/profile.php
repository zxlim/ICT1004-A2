    ...
    <div class="container">
        <div class="row s_product_inner">
            <?php if ($profile === NULL) { ?>
                ...
                <br/><br/><br/>
            <?php } else { ?>
                <input type="hidden" id="profile_id" name="profile_id" value="<?php safe_echo($profile["id"]); ?>"
                       required readonly>
                <div class="col-lg-4">
                    <div class="s_product_text">
                        ...
                        <figure>
                            <img class="rounded-circle" src="<?php safe_echo($profile["profile_pic"]); ?>"
                                 alt="User Profile Image" height="200" width="200">
                        </figure>
                    </div>
                </div>
                                        ...
                                        <div class="table-row bg-light">
                                            <div class="col-md-3">
                                                <figure class="img-equalise">
                                                    <img src="<?php safe_echo($row["url"]); ?>"
                                                         class="img-thumbnail user-listing">
                                                </figure>
                                            </div>
                                            ...
                                            <div class="col-md-2 name text-center">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <a class="genric-btn small primary"
                                                           href="item.php?id=<?php safe_echo($row["id"]); ?>">View</a>
                                                    </div>
                                                </div>
                                                <div class="row pt-3">
                                                    <div class="col-12">
                                                        <form class="form-confirm" action="profile.php" method="post">
                                                            ...
                                                            <input type="hidden" name="id"
                                                                   value="<?php safe_echo($row["id"]); ?>" required
                                                                   readonly>
                                                            <input type="hidden" class="confirm-msg"
                                        ...
                                        <div class="col-md-2 name text-center">
                                            ...
                                            <?php if ($session_user_id === $profile_id) { ?>
                                                <div class="row pt-3">
                                                    <div class="col-12">
                                                        <form class="form-confirm" action="profile.php" method="post">
                                                            <input type="hidden" name="action" value="sold_listing"
                                                                   required readonly>
                                                            <input type="hidden" name="id"
                                                                   value="<?php safe_echo($row["id"]); ?>" required
                                                                   readonly>
                                                            <input type="hidden" class="confirm-msg"
                                                                   value="Are you sure you want to mark this listing as sold?"
                                                                   required readonly>
                                        ...
                                        <div class="media">
                                            <div class="d-flex">
                                                <a href="profile.php?id=<?php safe_echo($row["buyer_id"]); ?>">
                                                    <img class="rounded-circle review-profile-pic"
                                                         src="<?php safe_echo($row["buyer_profile_pic"]); ?>"
                            ...
                            <div class="review_box">
                                ...
                                <?php } else { ?>
                                    <form class="contact_form" id="form-review">
                                        ...
                                        <div class="row pt-3">
                                            <div class="col-12 text-center">
                                                <button type="submit" value="submit" class="primary-btn">Submit Review
                                                </button>
                                            </div>
                                        </div>
                                    </form>
